# single-data-environment-user-journeys documentation build configuration file
#
...
project = "single-data-environment-user-journeys"
...
htmlhelp_basename = "single-data-environment-user-journeysdoc"
