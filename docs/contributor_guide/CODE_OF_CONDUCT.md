# Code of conduct for `single-data-environment-user-journeys`
...
- "Project", we mean this `single-data-environment-user-journeys` GitHub repository;
...
[gov.uk-data-labs@digital.cabinet-office.gov.uk][email-address]. All complaints will be
...
[email-address]: mailto:gov.uk-data-labs@digital.cabinet-office.gov.uk
